...
export const metadata = {
  title: "Baloncesto | EntradasDeportivas",
  description: "Entradas para partidos de baloncesto en España. Liga ACB, Euroliga y más.",
}
...
export default function BaloncestoPage() {
  ...
  const competiciones = [
    { name: "Liga ACB", description: "Liga Española de Baloncesto" },
    { name: "Euroliga", description: "Competición Europea" },
    { name: "Copa del Rey", description: "Torneo Nacional" },
    { name: "Supercopa", description: "Supercopa Endesa" },
  ]
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-4 text-pretty text-lg text-muted-foreground md:text-xl">
              Vive la emoción del baloncesto español y europeo
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-6 text-3xl font-bold tracking-tight text-foreground">Sobre el Baloncesto</h2>
            <div className="space-y-4 text-muted-foreground">
              <p className="text-pretty leading-relaxed">
                El baloncesto es un deporte de equipo jugado por dos conjuntos de cinco jugadores cada uno. El objetivo
                es anotar puntos lanzando el balón a través del aro del equipo contrario, que está montado a 3.05 metros
                de altura. Los partidos se dividen en cuatro cuartos de 10 minutos cada uno en competiciones FIBA.
              </p>
              <div className="grid gap-6 md:grid-cols-3">
                <Card>
                  <CardContent className="flex flex-col items-center gap-2 p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">5 por equipo en la cancha</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="flex flex-col items-center gap-2 p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">40 minutos (4 cuartos de 10')</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="flex flex-col items-center gap-2 p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">2 o 3 puntos por canasta</p>
                  </CardContent>
                </Card>
              </div>
              <p className="text-pretty leading-relaxed">
                La Liga ACB es una de las mejores ligas de baloncesto de Europa, con equipos que compiten regularmente
                en la Euroliga. España ha sido una potencia mundial en baloncesto, tanto a nivel de clubes como de
                selecciones nacionales, produciendo algunos de los mejores jugadores de la historia.
              </p>
            </div>
          </div>
        </div>
              ...
              <Card key={evento.id} className="transition-all hover:shadow-md">
                <CardContent className="flex flex-col gap-4 p-6 md:flex-row md:items-center md:justify-between">
                  ...
                  <Button asChild className="md:w-auto">
                    <Link href={`/contacto?evento=${evento.id}&deporte=baloncesto`}>
