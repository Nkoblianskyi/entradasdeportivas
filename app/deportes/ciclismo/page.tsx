...
import { ArrowRight, Bike, Trophy, Calendar, MapPin } from "lucide-react"

export const metadata = {
  title: "Ciclismo | EntradasDeportivas",
  description: "Entradas para eventos de ciclismo en España. Vuelta a España, Tour de Francia y más.",
}

export default function CiclismoPage() {
  const competiciones = [
    { nombre: "Vuelta a España", descripcion: "La gran vuelta ciclista española" },
    { nombre: "Tour de Francia", descripcion: "La carrera más prestigiosa del mundo" },
    { nombre: "Giro de Italia", descripcion: "Una de las tres grandes vueltas" },
    { nombre: "Clásicas", descripcion: "Las carreras de un día más importantes" },
  ]
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-4 text-pretty text-lg text-muted-foreground md:text-xl">
              Vive la emoción de las grandes vueltas y clásicas ciclistas
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-4xl">
            <Card className="border-primary/20">
              <CardContent className="p-8">
                <h2 className="mb-6 text-3xl font-bold text-foreground">Sobre el Ciclismo</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p className="leading-relaxed">
                    El ciclismo de ruta es un deporte de resistencia en el que los ciclistas compiten en carreras que
                    pueden durar desde unas pocas horas hasta tres semanas en las grandes vueltas. España es uno de los
                    países con mayor tradición ciclista del mundo.
                  </p>
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      <h3 className="mb-3 font-semibold text-foreground">Tipos de Carreras</h3>
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Grandes Vueltas: 21 etapas en 3 semanas</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Clásicas: Carreras de un día</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Contrarreloj: Individual o por equipos</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Etapas de montaña: Los puertos más duros</span>
                        </li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="mb-3 font-semibold text-foreground">Clasificaciones</h3>
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>General: Menor tiempo acumulado</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Puntos: Para los sprinters</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Montaña: Para los escaladores</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 text-primary">•</span>
                          <span>Jóvenes: Mejor ciclista sub-25</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                >
                  <CardContent className="flex flex-1 flex-col gap-4 p-6 md:flex-row md:items-center">
                    ...
                    <Button asChild className="md:w-auto">
                      <Link href="/contacto?deporte=ciclismo">
                        Solicitar Entradas
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-balance text-3xl font-bold tracking-tight text-foreground md:text-4xl">
              ¿Listo para vivir el ciclismo en directo?
            </h2>
